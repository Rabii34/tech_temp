...
if(isset($_POST['login'])){
   ...
   $login_pass=$_POST['log_password'];

   $log_verify="SELECT * from `user-data` where email='$login_email'";
   $connect_login=mysqli_query($connection,$log_verify);
   if(mysqli_num_rows($connect_login)>0){
     ...
     if($pass_decode){
      ...
      header('location:http://localhost/techtemp/index.php');
     }
     else{
               ...
               <div class="col-md-8 offset-md-2">
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" id="request" class="main_form">
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <input class="contactus" name="log_email" placeholder="email" type="email" >                          
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" name="log_password" placeholder="password" type="password">                          
                        </div>
