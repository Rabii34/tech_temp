...
if(isset($_POST['register'])){
   ...
   if(mysqli_num_rows($email_query) > 0){
      ...
      $$query = "INSERT INTO `user-data` (`username`, `email`, `password`) VALUES ('$user_name', '$user_email', '$pass')";
      $insert = mysqli_query($connection,$query);
      header('location:http://localhost/techtemp/login.php');
   }
}
?>
         ...
         <div class="container">
            <div class="row ">
               <div class="col-md-8 offset-md-2">
                  ...
                  <form  action="<?php echo $_SERVER['PHP_SELF']?>" method="POST" id="request" class="main_form">
                     <div class="row">
                        <div class="col-md-12">
                           <input class="contactus" name="name" placeholder="name" type="text" > 
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" name="email" placeholder="email" type="email">                          
                        </div>
                        <div class="col-md-12">
                           <input class="contactus" name="password" placeholder="password" type="password">                          
                        </div>
